...
const Post = ({ json }) => {
	...
	return (
        ...
        <script async custom-element="amp-social-share" src="https://cdn.ampproject.org/v0/amp-social-share-0.1.js" />
			...
			<h1>{json.parse.title}</h1>

			<div className="author">
				<img width={50} height={50} className="avatar" src={`/static/avatars/${author.gender}/${author.photo}`} /> <strong>{author.name}</strong>
			</div>
        ...
        <amp-social-share type="email" width="45" height="33" />
			...
			{/* <img width={600} height={400} layout="responsive" alt={post.title} src={`/static/images/${post.id}.jpg`} /> */}
